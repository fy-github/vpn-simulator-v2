        ...
        mock_resp.json.return_value = [
            {
                ...
                "name": "3G",
                "category": "mobile",
                "faults": {"latency": {"delay_ms": 200}, "packet_loss": {"loss_rate": 0.02}},
                "active": False,
            }
        ]
        mock_resp.raise_for_status = MagicMock()
        ...
        mock_resp.json.return_value = [
            {
                ...
                "name": "Test",
                "category": "test",
                "faults": {"bandwidth": {"bandwidth_kbps": 1000000}},
                "active": False,
            }
        ]
        mock_resp.raise_for_status = MagicMock()
        ...
        mock_resp.json.return_value = [
            {
                ...
                "name": "Test",
                "category": "test",
                "faults": {"bandwidth": {"bandwidth_kbps": 50000}},
                "active": False,
            }
        ]
        mock_resp.raise_for_status = MagicMock()
        ...
        mock_resp.json.return_value = [
            {
                ...
                "name": "Test",
                "category": "test",
                "faults": {"bandwidth": {"bandwidth_kbps": 500}},
                "active": False,
            }
        ]
        mock_resp.raise_for_status = MagicMock()
