...
const Layout = () => {
  ...
  const navItems = [
    ...
    { path: '/pcap', label: t('nav.pcap', 'PCAP Replay'), icon: PcapIcon, group: 'analytics' },
    { path: '/routing', label: t('nav.routing', 'Routing'), icon: RoutingIcon, group: 'analytics' },
    { path: '/grafana', label: t('nav.grafana', 'Grafana'), icon: GrafanaIcon, group: 'analytics' },
    ...
    { path: '/dhcp', label: t('nav.dhcp', 'DHCP'), icon: DHCPIcon, group: 'testing' },
    { path: '/impairment', label: t('nav.impairment', 'Impairment'), icon: ImpairmentIcon, group: 'testing' },
    { path: '/validation', label: t('nav.validation', 'Validation'), icon: ValidationIcon, group: 'testing' },
    ...
    { path: '/snmp', label: t('nav.snmp', 'SNMP'), icon: SnmpIcon, group: 'advanced' },
    { path: '/scale', label: t('nav.scale', 'Scale'), icon: ScaleIcon, group: 'advanced' },
    { path: '/c2', label: t('nav.c2', 'C2 Scenarios'), icon: C2Icon, group: 'advanced' },
    { path: '/retention', label: t('nav.retention', 'Retention'), icon: RetentionIcon, group: 'advanced' },
  ]
